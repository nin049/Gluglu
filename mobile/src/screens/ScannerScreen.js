...
export default function ScannerScreen({ navigation }) {
  ...
  const handlePickImage = async () => {
    ...
    // Scan du code-barre depuis l'image (expo-camera ne supporte pas ça nativement)
    // On guide l'utilisateur vers le scan caméra
    Alert.alert(
      'Conseil',
      'Pour de meilleurs résultats, montrez le code-barres directement à la caméra. Le scan depuis une photo de galerie n\'est pas encore supporté par Expo Camera.',
      [{ text: 'Compris' }]
    );
  };
      ...
      <View style={styles.overlay}>
        ...
        <View style={styles.bottomDim}>
          ...
          <TouchableOpacity style={styles.galleryBtn} onPress={handlePickImage}>
            <Text style={styles.galleryText}>Choisir depuis la galerie</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
...
export default function ScannerScreen({ navigation }) {
  ...
  // Reset automatique dès que l'écran reprend le focus (retour depuis ProductScreen)
  useFocusEffect(
    useCallback(() => {
      isProcessing.current = false;
      setLoading(false);
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Overlay sombre */}
      <View style={styles.overlay}>
        {/* Zone transparente simulée par bordures */}
        <View style={styles.topDim} />
        <View style={styles.middleRow}>
          <View style={styles.sideDim} />
          <View style={styles.scanWindow}>
